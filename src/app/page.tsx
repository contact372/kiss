...
function PageContent() {
  ...
  const handleSeeTheVideoClick = () => {
    let pricingUrl = '/pricing';
    if (user && user.email) {
      pricingUrl += `?email=${encodeURIComponent(user.email)}`;
    }

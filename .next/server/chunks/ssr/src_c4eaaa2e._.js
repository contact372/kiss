...
(()=>{
    const e = new Error("Cannot find module '@/app/actions'");
...
;
;
async function grantPaidAccess(uid) {
    try {
        ...
        console.error('[grantPaidAccess] Error:', error);
...
function PageContent() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const handlePostPayment = async ()=>{
            console.log('[DEBUG] Post-payment effect triggered for paid=true.');
            if (!user) {
            ...
            console.log(`[DEBUG] Calling grantPaidAccess for user ${user.uid}...`);
            const grantResult = await grantPaidAccess(user.uid);
            ...
            console.log('[DEBUG] Paid access granted successfully. Refreshing profile...');
            await refreshUserProfile();
...
//# sourceMappingURL=src_c4eaaa2e._.js.map
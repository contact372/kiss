...
async function fuseImages(image1DataUri, image2DataUri) {
    const prompt = [
        dataUriToMediaPart(image1DataUri),
        dataUriToMediaPart(image2DataUri),
        {
...
const generateKissVideoFlow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].defineFlow({
    ...
    if (input.image2DataUri) {
        const fusedImageUri = await fuseImages(input.image1DataUri, input.image2DataUri);
        sourceImageDataUri = fusedImageUri;
        promptContent.push(dataUriToMediaPart(fusedImageUri));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b4b07ebf._.js.map
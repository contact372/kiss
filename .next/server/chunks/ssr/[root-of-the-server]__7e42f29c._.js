...
const fetch = (url, init)=>__turbopack_context__.r("[project]/node_modules/node-fetch/lib/index.mjs [app-rsc] (ecmascript, async loader)")(__turbopack_context__.i).then(({ default: fetch })=>fetch(url, init));
...
const GenerateKissVideoInputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    image1DataUri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().describe("A photo of the two people side-by-side, as a data URI that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'."),
    image2DataUri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().optional() // Keep this optional for schema compatibility but it won't be used
});
...
async function videoGenerationFlow(input) {
    ...
    try {
        ...
        console.log(`[DEBUG] Request Body (first 100 chars of image): ${JSON.stringify({
            ...body,
            input: {
                ...body.input,
                image: body.input.image.substring(0, 100) + '...'
            }
        })}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e42f29c._.js.map
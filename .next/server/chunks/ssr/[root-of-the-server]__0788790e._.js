...
__turbopack_context__.s({
    ...
    "createSubscribedUserAdmin": (()=>createSubscribedUserAdmin),
...
async function createSubscribedUserAdmin(email) {
    // This is complex because we can't create a user with a password from here.
    // The webhook will just note that this email is a subscriber,
    // and the client will complete the signup.
    console.log(`Subscription for ${email} will be activated upon user creation.`);
}
async function activateUserSubscriptionAdmin(uid) {
    const userRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["doc"])(adminDb, 'users', uid);
    const docSnap = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["getDoc"])(userRef);
    if (!docSnap.exists()) {
        throw new Error("User profile does not exist. Cannot activate subscription.");
    }
    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["setDoc"])(userRef, {
        isSubscribed: true,
        credits: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["increment"])(15)
    }, {
        merge: true
    });
}
...
async function decrementUserCreditsAdmin(uid) {
    ...
    if (currentCredits > 0) {
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["setDoc"])(userRef, {
            credits: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$firestore__$5b$external$5d$__$28$firebase$2d$admin$2f$firestore$2c$__esm_import$29$__["increment"])(-1)
        }, {
            merge: true
        });
    } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0788790e._.js.map
...
"[project]/src/lib/firebase/data:7a99b2 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/firebase/data:e42c22 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$data$3a$7a99b2__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/firebase/data:7a99b2 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$data$3a$e42c22__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/firebase/data:e42c22 [app-client] (ecmascript) <text/javascript>");
;
...
;
;
// A new server action to fuse images, as it shouldn't be called directly from a client component.
async function fuseImagesAction(input) {
    'use server';
    // This is a simple wrapper for a flow.
    // In a real app, you might add more logic here.
    const { fuseImages } = await __turbopack_context__.r("[project]/src/ai/flows/fuse-images-flow.ts [app-client] (ecmascript, async loader)")(__turbopack_context__.i);
    try {
            ...
            async function handlePaymentSuccess() {
                if (searchParams.get('paid') === 'true' && user) {
                    try {
                        ...
                        const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$data$3a$7a99b2__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["checkUserSubscription"])(user.uid);
    ...
    const handleGenerate = async (isPaidOverride = false, postSignupParams)=>{
        ...
        if (isPaidFlow) {
            if (userProfile && !isPaidOverride) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2f$data$3a$e42c22__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["decrementUserCredits"])(userProfile.uid);
            }
            ...
            if (effectiveUploadMode === 'two' && effectiveImage1 && effectiveImage2) {
                try {
                    const fusedResult = await fuseImagesAction({
                        image1DataUri: effectiveImage1,
...
//# sourceMappingURL=src_fe9c8749._.js.map